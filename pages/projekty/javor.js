  ...
  return (
    <div>
      <div>
        <h1>Občan Javor</h1>
        <p>
          Aktualizovaný playlist videí z dílny Remízek k Javoru Stříbrnému na
          Anenském trojúhelníku
        </p>
        <p>SPOT</p>
        ...
        <Link href="https://www.ceskatelevize.cz/porady/1095913550-nedej-se/221562248430015-zachrana-javoru/?fbclid=IwAR0E2MwfjaiF2oUGF8ziZrJJeHhI5rOCxjSahiKID4ZFoRTijoum6ai28IY">
          https://www.ceskatelevize.cz/.../221562248430015.../…
        </Link>
        <p>Strom roku:</p>
      </div>
      ...
      <div>
        ...
        <div>
          ...
          <p>
            / Kamera: Jan Trnka, Zvuk: Kryštof, Střih: Kryštof, Marcel Halcin,
            Juliana Moska /
          </p>
        </div>
      ...
      <div>
        ...
        <div>
          ...
          <p>
            / Kamera: Jan Trnka, Michal Vasiľ, Adéla Kaiserová, Kryštof, Živý
            střih: Miky Arsenjev, Tereza Schrijversová, Adéla Kaiserová, Přenos:
            Kryštof, Zvuk: Nicolas Atcheson/
          </p>
