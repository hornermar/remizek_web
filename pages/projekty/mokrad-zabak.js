    ...
    <>
      ...
      <div className={styles.simplePage}>
        <div className={styles.container}>
          <h1 className={styles.title}>MOKŘAD ŽABÁK</h1>
          <p>
            Za posledních šedesát let zmizelo skoro 1 milion hektarů mokřadů.
          </p>
          <p>
          ...
          <h2>Proč? </h2>
          <p>
            Těchto oáz života dramaticky ubývá. Jsou zásadní i pro zachytávání
            vody a zachytávání CO2. Bohužel, narozdíl od betonu, negenerují
            politikům a developerům zisk. Jak lze zachránit mokřad jsme natáčeli
            v Lysé nad labem.
          </p>
          {/* <p>
        VIDEO TRAILER
        https://drive.google.com/file/d/1-v8rvItYevaD5WuGyYnIHtD0PQLIs_t7/view?usp=sharing
          ...
          <p>
            Dokumentární seriál z prostředí mokřadu žabák vypráví reálnou
            událost prodeje pozemků města Lysé nad Labem skrze zainteresované
            strany tohoto společensky významného střetu zájmů mezi ochranou
            přírody a zájmem kraje a obce vybudovat středisko pro edukaci dětí.
            Příběh je vyprávěn skrze svědectví opravdových lidí, zastupitelů a
          ...
          <p>
            ...
            napínavé snahy obyvatel zachránit konkrétní lokalitu, ke které
            získávají vztah. Pomocí unikátních záběrů získává vztah k tomuto
            kousku krajiny i divák, který uvidí vzácné druhy ptáků a živočichů a
            umožní tak hlouběji pochopit a prožít klimatickou změnu a uvažovat o
            ní i v kontextu jejich domova a obce.
          </p>
          <p>
